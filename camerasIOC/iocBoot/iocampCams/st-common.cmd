...
###############################
NDStdArraysConfigure("$(PREFIX)$(CAM):Image2", 3, 0, "$(PREFIX)$(CAM):OVER", 0, 0)
dbLoadRecords("$(ADCORE)/db/NDStdArrays.template", "P=$(PREFIX)$(CAM):,R=image2:,PORT=$(PREFIX)$(CAM):Image2,ADDR=0,TIMEOUT=1,NDARRAY_PORT=$(PREFIX)$(CAM):OVER,TYPE=Int16,FTVL=SHORT,NELEMENTS=$(NELM)")
